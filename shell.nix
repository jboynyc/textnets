...
mkShell {
  ...
  postShellHook = ''
    ...
    poetry install
    poetry install -E fca
    poetry install -E doc
    spacy validate | grep en_core_web_sm || poetry run pip install https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-3.4.0/en_core_web_sm-3.4.0.tar.gz
  '';
}
